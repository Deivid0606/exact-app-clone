...
const navItems: NavItem[] = [
  ...
  { id: 'products', label: 'Productos', roles: ['ADMIN', 'PROVEEDOR', 'DELIVERY', 'VENDEDOR', 'DESPACHANTE'] }, // ✅ AGREGADOS VENDEDOR y DESPACHANTE
  ...
  { id: 'qrScanner', label: '📷 QR Delivery', roles: ['ADMIN', 'PROVEEDOR', 'DELIVERY'] },
