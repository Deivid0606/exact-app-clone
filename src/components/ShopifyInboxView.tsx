    ...
    <div className="app-card">
      ...
      <div className="app-card !p-4 mb-4">
        ...
        <p className="text-xs text-muted-foreground mb-3">
          ...
          Columnas soportadas: tienda, fecha, nombre, número, calle, ciudad, departamento, producto, cantidad, monto, email.
        </p>
        <textarea className="app-input" rows={6} placeholder="Pegá acá las filas de tu planilla..." value={paste} onChange={e => setPaste(e.target.value)} />
