...
export default function ProductsView({ onLoadProduct }: { onLoadProduct?: (sku: string) => void }) {
  ...
  // ✅ Agregar estado para logos que fallan
  ...
  return (
    <div className="app-card">
      ...
      {grouped.map((group) => {
        // Verificar si el logo debe mostrarse o falló
        ...
        return (
          <div key={group.email || group.name} className="mb-6">
            <div className="flex items-center gap-3 mb-3 p-3 rounded-xl border border-border bg-secondary/50">
              {/* ✅ Logo del proveedor - ahora visible correctamente */}
              {showLogo ? (
                <img
                  src={group.logo}
                  alt={group.name}
                  ...
                  onError={() => {
                    // Si la imagen falla, la marcamos como fallida
              ...
              {/* ✅ Botón de WhatsApp - ya está implementado correctamente */}
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-1.5 mt-auto">
                        ...
                        {canSeeRealCost && (
                          <span className="chip text-[10px]">Real: {p.real_stock ?? 0}</span>
                        )}
                      </div>
                    </div>
