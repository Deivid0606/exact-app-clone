            ...
            {group.items.map((p) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className="relative w-full h-[180px] overflow-hidden bg-background border-b border-border flex items-center justify-center"
                  ...
                  <div
                    className="p-3.5 flex flex-col gap-2 flex-grow min-h-[120px]"
                    onClick={() => setExpandedId(isExpanded ? null : p.id)}
                  >
